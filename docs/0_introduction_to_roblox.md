...
This section covers the basics of navigating the platform and analyzing existing educational games.
...
Analyzing existing games is a great way to kick off a session. 
